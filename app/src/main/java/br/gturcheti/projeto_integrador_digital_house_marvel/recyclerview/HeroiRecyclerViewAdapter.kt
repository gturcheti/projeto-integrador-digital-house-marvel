package br.gturcheti.projeto_integrador_digital_house_marvel.recyclerview
...
class HeroiRecyclerViewAdapter(
    ...
    override fun onBindViewHolder(holder: HeroiRecyclerViewAdapter.ViewHolder, position: Int) {
